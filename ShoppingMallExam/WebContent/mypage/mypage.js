...
function go_cart_delete(){
	...
	if(count == 0){
		...
		document.formm.action = "CSCServlet?command=cart_delete";
		document.formm.submit();
	}
...
function go_order_insert(){
	document.formm.action = "CSCServlet?command=order_insert";
	document.formm.submit();
}
...
function go_order_delete(){
	...
	if(count==0){
		...
		document.formm.action = "CSCServlet?command=order_delete";
		document.formm.submit();
	}
